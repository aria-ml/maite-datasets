...
from maite_datasets._fileio import ResourcePart, URLResource, _download_part, _print, _remove_folder_nest
...
class DroneSwarm(YOLODataset):
    ...
    The dataset is approximately 153 MB and can be found on `kaggle <https://www.kaggle.com/datasets/simuletic/military-drone-swarm-and-saturation-attack-dataset>`_
    or on `huggingface <https://huggingface.co/datasets/Simuletic/Military-Drone-Swarm-Saturation-Attack-Dataset>`_.
